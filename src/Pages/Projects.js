...
const Projects = () => {
    return (
        <div className="bg-[#ddd] relative min-h-screen justify-center items-center md:w-6/6 max-sm:h-screen max-sm:w-screen h-full flex flex-col lg:flex-row pb-10">
            ...
            <section class="overflow-scroll grid gap-5 max-sm:gap-[100%] max-xs:gap-[100dvw] max-sm:ml-16 max-sm:mr-16 max-sm:grid-rows-1 max-sm:grid-cols-5 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 pt-32 relative">
